...
//    	fakeHeader.setTitle("Messaging Settings");
//    	getPreferenceScreen().addPreference(fakeHeader);
//    	addPreferencesFromResource(R.xml.pref_messaging);
		...
		bindPreferenceSummaryToValue(exampleText);
		bindPreferenceSummaryToValue(exampleList);
		bindPreferenceSummaryToValue(findPreference("notifications_new_message_ringtone"));
		
//		Preference server =  (Preference) findPreference("server_url_pref");
//	    server.setSummary(Common.getServerUrl());
//	    Preference id =  (Preference) findPreference("sender_id_pref");
//	    id.setSummary(Common.getSenderId());
//	    
